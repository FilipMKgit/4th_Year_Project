#this script evaluates clustering performance by comparing k-means cluster assignments  
...
kmeans_original_dir = base_dir / "k-means_data/K-means_data_K=6" #k-means results on original data
kmeans_pca_dir = base_dir / "k-means_data/K-means_data_PCA_K=6" #k-means results on pca data
kmeans_tsne_dir = base_dir / "k-means_data/K-means_data_tSNE_K=6" #k-means results on tsne data
kmeans_umap_dir = base_dir / "k-means_data/K-means_data_UMAP_K=6" #k-means results on umap data
...
################################################################
#evaluating k-means clustering results against annotated ground truth  

print("\nevaluating k-means - original data vs annotated data...")
metrics_gt_orig = compare_to_gt(load_csv(kmeans_original_dir), load_csv(ground_truth_dir)) #evaluate k-means on original data

print("\nevaluating k-means - pca data vs annotated data...")
metrics_gt_pca = compare_to_gt(load_csv(kmeans_pca_dir), load_csv(ground_truth_dir)) #evaluate k-means on pca data

print("\nevaluating k-means - tsne data vs annotated data...")
metrics_gt_tsne = compare_to_gt(load_csv(kmeans_tsne_dir), load_csv(ground_truth_dir)) #evaluate k-means on tsne data

print("\nevaluating k-means - umap data vs annotated data...")
metrics_gt_umap = compare_to_gt(load_csv(kmeans_umap_dir), load_csv(ground_truth_dir)) #evaluate k-means on umap data
